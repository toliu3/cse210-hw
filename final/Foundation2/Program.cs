...
class Program
{
    static void Main(string[] args)
    {
        ...
        Product p1 = new Product("iPhone 12", "IPH12", 999.99m, 1);
        Product p2 = new Product("Samsung Galaxy S21", "SGS21", 899.99m, 1);
        Product p3 = new Product("Sony WH-1000XM4 Headphones", "SONYXM4", 349.99m, 2);
        product1s.Add(p1);
        product1s.Add(p2);
        product1s.Add(p3);
        ...
        Product p21 = new Product("Widget", "W123", 19.99m, 2); 
        Product p22 = new Product("Gadget", "G456", 14.99m, 3);
        Product p23 = new Product("Accessory", "A789", 9.99m, 1);
        product2s.Add(p21);
        product2s.Add(p22);
        product2s.Add(p23);
